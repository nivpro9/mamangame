...
const LANGS = {
  en: { name:'English', flag:'🇬🇧', dir:'ltr', t:{
    ...
    allCompleteText:'🌟 You completed all 100 levels! Starting prestige run...',
    landHere:'LAND HERE',
  ...
  it: { name:'Italiano', flag:'🇮🇹', dir:'ltr', t:{
    ...
    allCompleteText:'🌟 Hai completato tutti i 100 livelli! Inizia il giro prestigio...',
  ...
  fr: { name:'Français', flag:'🇫🇷', dir:'ltr', t:{
    ...
    allCompleteText:'🌟 Vous avez complété les 100 niveaux! Démarrage du run prestige...',
  ...
  ru: { name:'Русский', flag:'🇷🇺', dir:'ltr', t:{
    ...
    allCompleteText:'🌟 Вы прошли все 100 уровней! Начинается престижный забег...',
  ...
  ja: { name:'日本語', flag:'🇯🇵', dir:'ltr', t:{
    ...
    allCompleteText:'🌟 全100レベルクリア！プレステージラン開始...',
    landHere:'ここに着陸',
  ...
  zh: { name:'中文', flag:'🇨🇳', dir:'ltr', t:{
    ...
    allCompleteText:'🌟 你完成了所有100关！开始声望挑战...',
    landHere:'在此降落',
    shieldPickupText:'🛡 +护盾!',
    bossIncoming:'⚔️ 首领来袭!',
    ammoFull:'弹药已满!',
  ...
  he: { name:'עברית', flag:'🇮🇱', dir:'rtl', t:{
    ...
    allCompleteText:'🌟 סיימת את כל 100 השלבים! מתחיל ריצת יוקרה...',
    landHere:'נחת כאן',
  ...
  ar: { name:'العربية', flag:'🇸🇦', dir:'rtl', t:{
    ...
    allCompleteText:'🌟 أكملت جميع المستويات الـ100! بدء جولة المكانة...',
    landHere:'الهبوط هنا',
